 ...
 *
 * A copy of the classic procedural generator, intended to be
 * incrementally refactored into a composable architecture where
 * grid cuts, tab shapes, and composition are separate, pluggable layers.
 *
 * See issue #127 for the design and sub-issues #128–#133 for
 * research decisions.
 *
 * Currently produces identical output to the classic generator.
 * Future refactoring will decompose this into:
 *   1. Grid cut layer (row/column cuts, straight or wavy)
 *   2. Tab shape layer (standalone tab templates)
 *   3. Composition layer (placing tabs on edges)
 *   4. Validation layer (proximity/intersection checks)
 */
